...
# \dontrun{
# #Test run with a focal individual from the Macleay River (EmmacMaclGeor) 
# test <- gl.assign.mahal(testset.gl,unknown='UC_00146',verbose=3)
# }

gl.assign.mahal <- function(x,
                            nmin=10,
                            dim.limit=NULL,
                            plevel=0.001,
                            n.best = NULL,
  ...
  x <- gl.join(x1=x,x2=unknown.ind,method="join.by.loc",verbose=0)
